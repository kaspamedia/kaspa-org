...
const translationPolicies = {
  de: {
    allowedUnchangedKeys: [
      ...
      "build.terms.node",
      "build.terms.utxo",
      "build.navigation.sections.start.label",
      "build.navigation.sections.start.compactLabel",
      "build.navigation.sections.tryLive.compactLabel",
      "build.navigation.sections.runNode.compactLabel",
      "build.navigation.sections.tooling.compactLabel",
      "build.navigation.sections.developments.compactLabel",
      "build.tryLive.examples.serverInfo.mobileTabLabel",
      "build.paths.cards.node.tier",
      "build.runNode.heading.label",
      "build.tooling.stable.wasm.tag",
      "build.tooling.emerging.python.status",
      "build.tooling.community.cards.indexer.type",
      "build.tooling.community.cards.khost.type",
      "build.access.groups.query.links.explorer",
      "build.access.groups.testnet.title",
      "build.developments.cards.research.label",
      "build.help.links.github.eyebrow",
      "build.help.links.discord.eyebrow",
      "errors.page.code",
      "hodl.navigation.current",
      "hodl.navigation.sections.wallet.compactLabel",
      "hodl.start.heading",
      "hodl.help.community",
      "hodl.help.discord",
      "hodl.help.explorer",
      "hodl.walletFinder.common.optional",
      ...
      "hodl.walletFinder.guidance.desktop.shortTitle",
      "hodl.walletFinder.guidance.hardware.shortTitle",
      "hodl.walletFinder.wizard.steps.criteria.subtitle",
      "hodl.walletFinder.wizard.steps.features.subtitle",
      "hodl.walletFinder.features.two_fa.label",
      "hodl.walletFinder.features.multisig.label",
      "hodl.walletFinder.results.walletColumn",
      "hodl.walletFinder.actions.app_store",
      "hodl.walletFinder.actions.google_play",
      "home.proof.sections.live",
      "home.proof.supply.comparison.unit",
      "home.proof.supply.timeline.genesis.label",
      "home.proof.supply.timeline.checkpoint.label",
      "home.proof.supply.timeline.crescendo.label",
      "home.proof.supply.timeline.live",
      "lore.metadata.title",
  ...
  "id-ID": {
    allowedUnchangedKeys: [
      ...
      "build.runNode.heading.label",
      "build.tooling.emerging.python.status",
      "build.tooling.community.cards.dnsSeeder.type",
      "build.tooling.community.cards.khost.type",
      "build.access.groups.testnet.title",
      "build.developments.cards.research.label",
      "errors.page.code",
  ...
  ko: {
    allowedUnchangedKeys: [
      ...
      "build.terms.dag",
      "build.terms.utxo",
      "build.help.links.telegram.title",
      "errors.page.code",
      "hodl.navigation.current",
      "hodl.start.heading",
      "hodl.help.discord",
